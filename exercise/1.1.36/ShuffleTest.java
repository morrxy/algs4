 ...
 * command-line arguments M and N, does N shufﬂes of an array of size M that is
 * initialized with a[i] = i before each shufﬂe, and prints an M-by-M table such that row i
 * gives the number of times i wound up in position j for all j. All entries in the array 
 * should be close to N/M.
 *
 * java ShuffleTest 1000 10
 */
...
public class ShuffleTest {
	...
	public static void shufﬂe(int[] a) {
		int N = a.length;
		for (int i = 0; i < N; i++) {
