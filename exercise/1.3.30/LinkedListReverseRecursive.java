 ...
 * Iterative solution
 *
 * java LinkedListReverseRecursive
 * to be or not
 * ^z / ^d
 * not or be to
 * 
...
public class LinkedListReverseRecursive<Item> implements Iterable<Item> {
	...
	public static void main(String[] args) {
		...
		LinkedListReverseRecursive<String> q = new LinkedListReverseRecursive<String>();
