 ...
 *  Execution:    java RedBlackBST1 < input.txt
...
public class RedBlackBST1<Key extends Comparable<Key>, Value> {
    ...
    private Value get(Node x, Key key) {
        while (x != null) {
            ...
            if      (cmp < 0) x = x.left;
                ...
                // if (x.color == RED) StdOut.println("red");
                return x.val;
            }
        }
        return null;
    ...
    *****************************************************************************/
    public static void main(String[] args) {
        RedBlackBST1<String, Integer> st = new RedBlackBST1<String, Integer>();
