/*************************************************************************
 *  Compilation:  javac LinearProbingHashST1.java
 *  Execution:    java LinearProbingHashST1
 *
 *  Symbol table implementation with linear probing hash table.
 *
 *  % java LinearProbingHashST1
 *  128.112.136.11
 *  208.216.181.15
 *  null
 *
...
public class LinearProbingHashST1<Key, Value> {
    ...
    private void resize(int capacity) {
        LinearProbingHashST1<Key, Value> temp = new LinearProbingHashST1<Key, Value>(capacity);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
